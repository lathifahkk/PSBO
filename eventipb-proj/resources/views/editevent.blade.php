                    ...
                    <h4>Edit Informasi Kegiatan</h4>
                        <div class="col-md-6">
                            ...
                            <div class="form-field">
                                ...
                                <input list="ktgs" name="kategori" id="ktg" class="form-control" placeholder="Pilih kategori kegiatan"   value="{{ $latest->kategori }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-field">
                                ...
                                <input type="number" name="jumlah_tiket" class="form-control" placeholder="0" value="{{ $event->jumlah_tiket}}" required/>
                            </div>
                            <div class="form-field">
