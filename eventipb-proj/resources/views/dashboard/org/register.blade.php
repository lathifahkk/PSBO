...
<body>
    <div class="wrapper">
        ...
        <img src="{{url('/image/IPBEvent.png')}}" alt="IPB EVENT">
            ...
            <div class="right">
                <ul>
                    <li><a href="{{ route('org.login') }}"><button class="btn btn-outline-light" type="button" style="font-weight:bold">Login</button></li></a>
                </ul>
            </div>
    </div>
        ...
        <div class="container">
            <div class="row no-gutters">
                <div class="row">
                    ...
                    <div class="col-lg-7">
                    <form action="{{ route('org.create') }}" method="post">
                        ...
                        @csrf
                            <div class="form-row">
                                <h5>Organization's Event Register</h5>
                            </div>
                            <div class="form-row">   
                                ...
                                <div class="form-field">
                                    ...
                                    <input type="text" class="form-control" name="email" placeholder="Isi NIM/NRP anda" value="{{ old('email') }}" required/>
                                    <span class="text-danger">@error('email'){{ $message }} @enderror</span>
                                </div>
                                <div class="form-field">
                                    <label class="label">Lembaga Kemahasiswaan</label>
                                    <input list="ktgs" name="lembaga" id="ktg" class="form-control" placeholder="Pilih kategori kegiatan" value="{{ old('lembaga') }}" required="">
                                    <span class="text-danger">@error('lembaga'){{ $message }} @enderror</span>

                                    <datalist id="ktgs">
                                    <option value="Fakultas">
                                    <option value="Departemen">
                                    <option value="UKM Seni dan Budaya">
                                    <option value="UKM Olah Raga">
                                    <option value="UKM Kerohanian">
                                    <option value="UKM Bidang Khusus">
                                    <option value="UKM Bidang Keilmuwan">
                                    <option value="UKM Bela Diri">
                                    </datalist>
                                </div>
                                <div class="form-field">
                                ...
                                <div class="form-field">
                                    ...
                                    <input type="password" class="form-control" name="cpassword" placeholder="Isi password" value="{{ old('cpassword') }}" required/>
